    ...
    if not st.session_state.model_loaded:
        ...
        with col1:
            subject = st.selectbox(
                "📚 Subject",
                options=["NLP", "Calculus", "Applied Physics", "ICT", "Automata", "COAL"],
        ...
        with col2:
            question_type = st.selectbox(
                "📝 Question Type",
                options=["MCQ", "Short Answer", "Long Answer", "programming", "output"],
            ...
            with st.expander(" Advanced Options"):
                use_sampling = st.checkbox(
                    "Use Sampling (more diverse, slower)",
                    value=True,
                    help="Enable sampling for more diverse questions"
                )
                ...
                temperature = st.slider(
                    ...
                    value=0.9,
                    step=0.1,
                    help="Higher values = more random/creative"
                )
                ...
                max_length = st.number_input(
                    ...
                    value=128,
                    step=10,
                    help="Maximum length of generated question"
                )
