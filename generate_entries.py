...
# Generate entries and output as CSV lines
output = io.StringIO()
for course_code, course_info in courses.items():
    ...
    for i in range(50):
        ...
        # Write CSV line
        line = f'{course_code}{new_id},{course_info["subject"]},{topic},{year},{exam_type},{question_type},{difficulty},"{question_escaped}"\n'
        output.write(line)

# Write to file
with open('new_entries.csv', 'w', encoding='utf-8') as f:
    f.write(output.getvalue())

print(f'Generated {7 * 50} new entries in new_entries.csv')
